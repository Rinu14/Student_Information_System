              ...
              <form method="POST"action="{{route('students.store')}}">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="" name="blood_group"class="form-control" id="exampleInputBlood_Group1" placeholder="Enter blood_grp">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" name="phone_no"class="form-control" id="exampleInputPhone1" placeholder="Enter Phone no.">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputTemp-Address1">Temporary Address</label>
                    <input type="text" name="temp_address"class="form-control" id="exampleInputTemp-Address1" placeholder="Enter Temporary address">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPerm_Address1">Permanent Address</label>
                    <input type="text" name="perm_address"class="form-control" id="exampleInputPerm_Address1" placeholder="Enter Permanent Address">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date"name='dob'class="form-control" id="exampleInputDOB1"placeholder="Enter your date of birth">
                  </div>
                <!-- /.card-body -->
